...
export class Engine {
  ...
  private connectEntity(entity: Entity) {
    entity.onComponentAdded.connect(this.onComponentAdded, math.huge);
    entity.onComponentRemoved.connect(this.onComponentRemoved, math.huge);
    entity.onInvalidationRequested.connect(this.onInvalidationRequested, -math.huge);
  }
